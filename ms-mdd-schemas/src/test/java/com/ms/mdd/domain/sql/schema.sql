...
CREATE TABLE t_users_roles (
  ...
  deleted          INTEGER  NOT NULL DEFAULT -1,
  PRIMARY KEY (id),
  CONSTRAINT 'fk_users_roles_user_id' FOREIGN KEY ('user_id') REFERENCES 't_user' ('id'),
  CONSTRAINT 'fk_users_roles_role_id' FOREIGN KEY ('role_id') REFERENCES 't_role' ('id')
)
  ENGINE =InnoDB
  DEFAULT CHARSET=UTF8;
...
ALTER TABLE t_permission ADD INDEX idx_permission_resource_code (resource_code);
...
ALTER TABLE t_roles_permissions ADD CONSTRAINT fk_roles_permissions_role_id FOREIGN KEY (role_id) REFERENCES roles (id);
ALTER TABLE t_roles_permissions ADD CONSTRAINT fk_roles_permissions_permission_id FOREIGN KEY (permission_id) REFERENCES permissions (id);
...
CREATE TABLE t_menu_resources (
  ...
  ENGINE =InnoDB
  DEFAULT CHARSET=UTF8;
ALTER TABLE t_menu_resources ADD INDEX idx_menu_resources_resource_code (resource_code);
